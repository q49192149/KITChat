            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="academic_year" class="col-md-4 col-form-label text-md-right">{{ __('academic_year') }}</label>
                            <div class="col-md-6">
                                <input id="academic_year" type="text" class="form-control @error('academic_year') is-invalid @enderror" name="academic_year" value="{{ old('academic_year') }}" required autocomplete="academic_year">
                                @error('academic_year')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
